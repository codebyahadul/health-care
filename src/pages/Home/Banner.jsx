...
const Banner = () => {
    return (
        <div className='my-3 md:my-5 lg:my-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 lg:grid-rows-3 gap-5 items-end justify-center my-10 *:border *:rounded-xl'>
                <div className='p-5 bg-[#FBFBFB] row-span-3 space-y-2 mx-auto'>
                ...
                <div className='p-5 bg-[#FBFBFB] row-span-2'>
